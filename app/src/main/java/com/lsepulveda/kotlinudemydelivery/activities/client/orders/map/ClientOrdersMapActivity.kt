...
//            addDeliveryMarker()
    ...
    private fun connectSocket() {
        ...
        // solo se va a emitir data a la orden que estamos trabajando
        // sino se emitiria a todos los usuarios, habria confusion de deliverys
        socket?.on("position/${order?.id}") { args ->
            if (args[0] != null) {
                // necesitamos correrlo en el hilo principal de la app
                runOnUiThread {
