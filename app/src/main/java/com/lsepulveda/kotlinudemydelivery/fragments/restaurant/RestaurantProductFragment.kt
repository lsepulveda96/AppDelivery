...
class RestaurantProductFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // los numeros son solo identificadores para ver que imagen selecciona
    ...
    private fun isValidForm(name: String, description: String, price: String): Boolean {
        ...
        // si aprobo todas las validaciones anteriores el formulario es valido
        return true
    }

    // para manejar los estados con request code para seleccionar imagenes // deprecado pero funciona
